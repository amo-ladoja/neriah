...
/**
 * Open Gmail link - uses universal links that Gmail app intercepts
 * Gmail app on iOS and Android registers as handler for mail.google.com URLs
 * When app is installed, OS opens app; otherwise opens web
 */
export function openGmailLink(webUrl: string, messageId?: string) {
  if (typeof window === "undefined") return;

  // Gmail app intercepts mail.google.com URLs when installed
  // This works on both iOS and Android without custom URL schemes
